...
int main()
{
    ...
    cout << str1 << endl;//first string
    cout << str2 << endl;//first string
    cout << str3 << endl;//#####
    cout << str4 << endl;//string
    cout << str5 << endl;//first
    ...
    cout << "Length of string is : " << len << endl;//6
    ...
    cout << "third character of string is : " << ch << endl;//r
 ...
 */
    ...
    cout << str6 << endl;//string extension
    cout << str4 << endl;//string
    ...
    cout << str6.substr(7, 3) << endl;//ext
 
    //  if second argument is not passed, string till end is
    // taken as substring
    cout << str6.substr(7) << endl;//extension
 
    //  erase(a, b) deletes b character at index a
    str6.erase(7, 4);
    cout << str6 << endl;//string nsion
 
    //  iterator version of erase
    str6.erase(str6.begin() + 5, str6.end() - 3);
    cout << str6 << endl;//strinion
